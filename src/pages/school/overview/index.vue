<!--用户: Mr.wang     日期:2018/12/21    时间:15:45-->
<template>
    <div>
                ...
                <div class="header_top_title">
                    <div class="title_details">
                        <div class="title_details_left">
                            ...
                            <div>
                                <img :src="require('@/assets/images/overview/class.png')" alt=""><span class="">{{current_header_top['header_top_title'].school_num}}个班级</span>
                        ...
                        <div class="title_details_right">
                            ...
                            <div class="title_details_right_com">
                                <div class="border_right">
                                    ...
                                    <span style="font-size: 12px;color:#000000;">上线32人</span>
                                </div>
                            </div>
                            <div class="title_details_right_com">
                                <div class="border_right">
                                    <p><img :src="require('@/assets/images/overview/icon_pjf.png')"
                                            alt=""><span>全校均分</span></p>
                            ...
                            xAxis: [
                                {
                                    ...
                                    position: 'bottom',
                                    type: 'category',
                                    data: ['高二1班', '高二1班', '高二1班', '高二1班', "高二1班", "高二1班", "高二1班", "高二1班"],
                                    axisLine: {
                                        show: false
                                    },
                                    axisTick: {
