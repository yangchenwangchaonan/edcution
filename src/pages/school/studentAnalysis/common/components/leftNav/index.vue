<!--用户: Mr.wang     日期:2018/12/16    时间:20:27-->
<template>
    <div class="tch_lf_title">
        <div class="tch_lf_msg">
            ...
            <div class="tch_tab_info" v-if="show">
                <p @click="handleActive" :class="active==0?'tch_tab_info_active':''">上线情况</p>
                <p @click="handleActive1" :class="active==1?'tch_tab_info_active':''">超均率分析</p>
            </div>
        </div>
        <div class="tch_lf_msg">
            <div class="tch_tab"  @click="handleActive2" :class="active==3?'tch_tab_info_active':''">
                ...
                <p :class="active==3?'tch_tab_info_active':''">试卷质量</p>
            </div>
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        methods: {
            ...
            handleActive () {
                // this.active=true
                this.$router.push({path:"/school/studentAnalysis/passrate"})
            },
            handleActive1 () {
                // this.active=false
                this.$router.push({path:"/school/studentAnalysis/average"})
            },
            handleActive2 () {
                // this.active=null
                this.$router.push({path:"/school/studentAnalysis/quality"})
            }
        }
    }
</script>
